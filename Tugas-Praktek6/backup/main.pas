...
type
  ...
  TForm1 = class(TForm)
    ...
    procedure smoothingButtonClick(Sender: TObject);
...
procedure TForm1.smoothingButtonClick(Sender: TObject);
var
  x , y : integer;
  smoothR , smoothG , smoothB: integer;
begin
  for y:=0 to Height-1 do
  begin
    for x:=0 to Width-1 do
    begin
      smoothR := (bitmapR[x,y] + bitmapR[x-1,y-1] + bitmapR[x+1,y+1] + bitmapR[x-1,y] + bitmapR[x,y-1] + bitmapR[x+1,y-1] + bitmapR[x-1,y+1] + bitmapR[x+1,y] + bitmapR[x,y+1])div 9;
      smoothG := (bitmapG[x,y] + bitmapG[x-1,y-1] + bitmapG[x+1,y+1] + bitmapG[x-1,y] + bitmapG[x,y-1] + bitmapG[x+1,y-1] + bitmapG[x-1,y+1] + bitmapG[x+1,y] + bitmapG[x,y+1])div 9;
      smoothB := (bitmapB[x,y] + bitmapB[x-1,y-1] + bitmapB[x+1,y+1] + bitmapB[x-1,y] + bitmapB[x,y-1] + bitmapB[x+1,y-1] + bitmapB[x-1,y+1] + bitmapB[x+1,y] + bitmapB[x,y+1])div 9;

      image2.Canvas.Pixels[x,y] := RGB(smoothR , smoothG , smoothB);
    end;
  end;
